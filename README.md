...
- Notifies municipalities for cleanup
- Uses crowdsourced data to keep streets clean

## Features

✨ **Real-time proximity alerts**
🗺️ **Interactive map with poop markers**
📱 **Progressive Web App (install on your phone!)**
📍 **GPS-based reporting**
🏛️ **Municipality notifications**
🔬 **AR & sensor integration framework**
🌍 **OpenStreetMap + Google Maps support**
